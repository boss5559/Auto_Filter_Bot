...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003132923661 -1002910368663').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Ovesh") # Database name (default: cluster)
