...
BOT_TOKEN = environ.get('BOT_TOKEN', "8354899213:AAFOAY3p-7sW-pjcQ3SYMi3pRVLuKdNnbps")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://graph.org/file/12082ded31fcbd636e36b-fd8a81ec21d987a646.jpg')).split()  # Sample pic
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003166629808'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002607722977')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003280987211')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/OnlyBossMoviesGroup')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002342243776")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hackersehzan_db_user:7XwTVPgxUxmswpmL@cluster0.sxwdosl.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'boss_files') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "False"), False) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Ovesh:ovesh.boss@ovesh.95jpp8g.mongodb.net/?retryWrites=true&w=majority&appName=Ovesh")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://telegram.me/Ovesh_Boss') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/OveshBossOfficial') # Update channel link for the bot

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1416433622').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5134768968 1416433622').split()]
